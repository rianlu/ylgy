...
class YglyApplication : Application() {
    ...
    override fun onCreate() {
        ...
        httpDownloadManagerImpl =
            HttpDownloadManagerImpl(DownloadConfig(), downloadFactory = object :
                HttpDownloadFactory {
                override fun acquireTask(): HttpDownloadTask? {
                    val downloadRecord = db.downloadRecordDao().getDownloadRecord()
