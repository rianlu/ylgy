...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataList = listOf(
            ...
            Playlist(2, "http://p2.music.126.net/5WBF8uSFXhLVjvMOCeqflQ==/109951167859171747.jpg?param=177y177", "启示录", "华语创作天后G.E.M.邓紫棋第八张全创作专辑《启示录》\n" +
                    "\n" +
                    "七封致天堂的信 七封天堂的回信\n" +
                    "\n" +
                    "为爱的启示掀开神圣序幕\n" +
            ...
            Playlist(3, "http://p1.music.126.net/kVwk6b8Qdya8oDyGDcyAVA==/1364493930777368.jpg?param=177y177", "新的心跳", "暌违三年，褪去青涩，已然成熟的G.E.M. 交出这张《新的心跳》； 新的心跳，带来新的声音、新的感触；对过去说再见，她带着轻盈的脚步向着前方的一束光迈进。\n" +
                    "\n" +
            ...
            Playlist(4, "https://p1.music.126.net/4NCWg3v2J2yjxk0-ciJs7w==/109951168669105675.jpg?param=200y200", "自然之音/沉浸大自然 静谧与美好之中", "像是偏临黄昏时混杂着青绿与烟黄的深山，隐居于此的道士悠然拨动了沉睡的琴弦。恍惚隔世间，雨滴凝聚在微倾的檐侧，晕染一片青苔。猛然惊觉，却是黄粱一梦，歇了车马，散了秋凉."),
            Playlist(5, "https://p1.music.126.net/g2_Gv0dtAicJ3ChTYu28_g==/1393081239628722.jpg?param=200y200", "深度睡眠 |重度失眠者专用歌单", "介绍： 好希望这里可以成为大家的一个庇护所\n" +
                    "在深夜安安静静不吵不闹\n" +
                    "路过的朋友留下一个故事或沉默\n" +
                    "大家都彼此默契\n" +
                    "等待天明。"),
            Playlist(6, "https://p1.music.126.net/ndGlV_dfHvAonoDr5SL3XA==/109951164247329551.jpg?param=200y200", "公路音乐|纵情追逐梦想与远方", "介绍： 关于公路\n" +
        ...
        binding.playlistRecyclerView.addItemDecoration(object : ItemDecoration() {
            override fun getItemOffsets(
                ...
                if (parent.getChildAdapterPosition(view) == dataList.size - 1) {
                    outRect.bottom = 300
                }
            }
        })
